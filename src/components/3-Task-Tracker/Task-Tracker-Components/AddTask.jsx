                    ...
                    <div className="flex items-center justify-center overflow-x-hidden overflow-y-auto fixed inset-0 z-100">
                        ...
                        <div className='w-9/12 max-w-lg bg-white border rounded-lg shadow-md relative flex flex-col'>
                            ...
                            <form className='px-6 pt-6 pb-4'>
                                <div>
                                    <label className='track-wide uppercase text-gray-700 text-xs font-semibold md-2 block' htmlFor='project-name'>
                                    Project Name
                                </label>
                                <input
                            ...
                            <div className='flex jusify-end p-6 border-slate-200 rounded-b'>
                                <button
